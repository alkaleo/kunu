...
export function JourneyTransition() {
  ...
  return <main className="journey-transition" aria-label="Traveling to Yosemite">
    ...
    <motion.div className="kunu-plane" initial={{ x: '-36vw', y: '24vh', rotate: -8 }} animate={{ x: '45vw', y: '-7vh', rotate: 4 }} transition={{ delay: reducedMotion ? 0 : .9, duration: reducedMotion ? .5 : 3.7, ease: 'easeInOut' }}><i/><span className="plane-clara"/><CharacterArt className="plane-generated-clara" variant="portrait"/><span className="plane-buddy"/></motion.div>
